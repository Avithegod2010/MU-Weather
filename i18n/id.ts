...
export const id: Strings = {
  ...
  storm_measure: 'Ukur lagi', storm_thunder: 'Kudengar guntur', storm_flash: 'Kulihat kilat', storm_hint: 'Lihat kilat? Ketuk kilat, lalu ketuk lagi saat guntur terdengar.',
  ...
  alert_rain_title: 'Peringatan hujan', alert_rain_sub: 'Beri tahu jika hujan signifikan diprakirakan dalam 12 jam ke depan', alert_thunder_title: 'Peringatan badai petir', alert_thunder_sub: 'Beri tahu saat badai petir muncul di prakiraan', alert_frost_title: 'Peringatan embun beku', alert_frost_sub: 'Beri tahu saat suhu malam turun ke 0°C atau di bawahnya', alert_uv_title: 'Peringatan UV', alert_uv_sub: 'Beri tahu saat indeks UV sangat tinggi', alert_pollen_title: 'Peringatan polen', alert_pollen_sub: 'Beri tahu saat kadar polen tinggi (hanya Eropa)', alert_aqi_title: 'Peringatan kualitas udara', alert_aqi_sub: 'Beri tahu saat kualitas udara tidak sehat', alert_pressure_title: 'Peringatan tekanan', alert_pressure_sub: 'Beri tahu saat tekanan udara turun cepat', alert_wind_title: 'Peringatan angin', alert_wind_sub: 'Beri tahu saat angin atau hemburan kuat diperkirakan',
