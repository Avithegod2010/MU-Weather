...
export const id: Strings = {
  ...
  notif_digest_action: 'Bacakan prakiraan', digest_high: 'Tertinggi', digest_low: 'Terendah', digest_rain: '{n}% hujan', digest_uv: 'UV {n}', notif_digest_title: 'Besok dalam sekilas', notif_golden_title: 'Golden hour segera', notif_golden_body: 'Cahaya keemasan mulai sekitar {n} menit lagi — sempurna untuk foto.',
  alert_rain_title: 'Peringatan hujan', alert_rain_sub: 'Beri tahu jika hujan signifikan diprakirakan dalam 12 jam ke depan', alert_thunder_title: 'Peringatan badai petir', alert_thunder_sub: 'Beri tahu saat badai petir muncul di prakiraan', alert_frost_title: 'Peringatan embun beku', alert_frost_sub: 'Beri tahu saat suhu malam turun ke 0°C atau di bawahnya', alert_uv_title: 'Peringatan UV', alert_uv_sub: 'Beri tahu saat indeks UV sangat tinggi', alert_pollen_title: 'Peringatan polen', alert_pollen_sub: 'Beri tahu saat kadar polen tinggi (hanya Eropa)', alert_aqi_title: 'Peringatan kualitas udara', alert_aqi_sub: 'Beri tahu saat kualitas udara tidak sehat', alert_pressure_title: 'Peringatan tekanan', alert_pressure_sub: 'Beri tahu saat tekanan udara turun cepat', alert_wind_title: 'Peringatan angin', alert_wind_sub: 'Beri tahu saat angin atau hemburan kuat diperkirakan', alert_cape_title: 'Peringatan pembentukan badai', alert_cape_sub: 'Beri tahu saat ketidakstabilan atmosfer tinggi tanpa badai yang diprakirakan', alert_heat_title: 'Peringatan panas', alert_heat_sub: 'Beri tahu saat suhu tertinggi hari mencapai 30° atau lebih',
  ...
  tile_climate: 'Iklim', tile_onthisday: 'Pada hari ini', card_climate: 'Yang normal di sini', climate_loading: 'Memuat rata-rata iklim…',
  ...
  climate_delta_typical: 'Tepat seperti {month} yang khas', climate_year_note: 'Terhangat: {hottest} · Terdingin: {coldest} · Terbasah: {wettest}', climate_rain_normal: 'Hujan normal: {n}', card_onthisday: 'Cuaca pada hari ini', otd_years_ago: '{n} tahun lalu', otd_one_year_ago: 'Setahun lalu',
  ...
  settings_about: 'Tentang', settings_about_sub: 'Versi, privasi, dan kebijakan data', s_general_note: 'Personalisasi lainnya hadir di pembaruan mendatang.', s_lang_note: 'Konten cuaca telah diterjemahkan. Bahasa lainnya hadir di pembaruan mendatang.', s_tiles_intro: 'Matikan apa pun yang tidak Anda perlukan dan hilang dari layar utama. Pilihan Anda disimpan di perangkat ini.', s_tiles_note: 'Cuaca saat ini dan peringatan berat selalu tetap aktif.', about_title: 'Tentang MU Weather', about_version: 'Versi {v}', about_privacy: 'Semua data Anda tetap di perangkat ini. Tanpa akun, tanpa pelacakan, tanpa analitik.', about_sources_note: 'Data cuaca berasal dari penyedia independen. Lihat Sumber data untuk daftar lengkap dan status langsung.', about_license_note: 'Proyek hobi pribadi. Data prakiraan © Open-Meteo (CC-BY 4.0), MET Norway, Windy.', nowcast_no_data: 'Tidak ada data per menit', nowcast_no_rain: 'Tidak ada hujan dalam 3 jam ke depan', nowcast_starting_min: 'Hujan mulai dalam sekitar {n} mnt', nowcast_starting_time: 'Hujan diperkirakan sekitar {time}', nowcast_continuing: 'Hujan berlanjut selama 3 jam ke depan', nowcast_easing_min: 'Hujan mereda dalam sekitar {n} mnt', nowcast_easing_time: 'Hujan mereda sekitar {time}', theme_system: 'Sistem', theme_light: 'Terang', theme_dark: 'Gelap', sync_waiting: 'Menunggu sinkronisasi pertama', sync_last: 'Sinkronisasi terakhir {time}', src_intro: 'MU Weather menggabungkan beberapa penyedia independen untuk akurasi terbaik. Prakiraan utama terus dicocokkan dengan layanan cuaca nasional kedua.', src_met_delta: 'MET {x}° vs aplikasi {y}°', src_drift: 'rata-rata penyimpangan {d}° dari {n} pemeriksaan', src_footer: 'Sumber: open-meteo.com · met.no · windy.com',
  s_pressure: 'Satuan tekanan', s_pressure_sub: 'Barometer, kartu tekanan, dan tampilan detail', s_beaufort: 'Skala Beaufort', s_beaufort_sub: 'Tampilkan nama gaya Beaufort di samping kecepatan angin', bft_force: 'Gaya {n}', bft_0: 'Tenang', bft_1: 'Angin semu', bft_2: 'Angin ringan', bft_3: 'Angin sedang', bft_4: 'Angin sedang-sedang', bft_5: 'Angin segar', bft_6: 'Angin kencang', bft_7: 'Angin sangat kencang', bft_8: 'Angin badai', bft_9: 'Badai kuat', bft_10: 'Badai hebat', bft_11: 'Badai dahsyat', bft_12: 'Topan', baro_measuring: 'Mengukur…', baro_rising_fast: 'Naik cepat ({n}/10mnt)', baro_falling_fast: 'Turun cepat ({n}/10mnt)', baro_measured_by: 'Diukur oleh ponsel Anda · langsung', baro_forecast_sea: 'Prakiraan (permukaan laut): {n}', baro_at_altitude: '{n} di ketinggian Anda', baro_no_sensor: 'Tidak ada sensor barometer di perangkat ini',

  // ── bot1: ensemble + multi-model ──
  trend_band_label: 'Ensemble P10–P90',
  trend_band_caption: 'diarsir = rentang ensemble 80%',
  digest_conf: '±{n}° ({band})',
