...
export const nl: Strings = {
  ...
  s_homebg: 'Startachtergrond', s_homebg_sub: 'Dynamisch volgt het live weer met regen en sneeuw', s_tileanim: 'Tegel-animatie', s_tileanim_sub: 'Hoe detail schermen openen en sluiten',
