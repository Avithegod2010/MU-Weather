export const en = {
  ...
  aurora_now: 'Kp now',
  aurora_forecast: 'Next 3 days',
  aurora_chance_high: 'Good chance — get somewhere dark',
  aurora_chance_maybe: 'Possible if skies stay clear',
  aurora_chance_low: 'Too faint this far south',
  aurora_source: 'NOAA Space Weather',
  card_best_window: 'Best time outdoors',
  best_window_line: '{time} looks best today',
  tile_best_window: 'Best time outdoors',
  wear_jacket: 'Jacket weather — {n}',
  wear_shirt: 'Shirt weather — {n}',
  wear_shorts: 'Shorts weather — {n}',
  wear_umbrella: 'bring an umbrella',
  wear_sunscreen: 'wear sunscreen',
  wear_windy: 'it is gusty out',
  alert_aurora_title: 'Aurora watch',
  alert_aurora_sub: 'Notify me when geomagnetic activity may bring aurora overhead',
  alert_fog_title: 'Fog watch',
  alert_fog_sub: 'Notify me when visibility drops or fog is forecast nearby',
  alert_blackice_title: 'Icy roads watch',
  alert_blackice_sub: 'Notify me when near-freezing rain may glaze roads',
  alert_coldsnap_title: 'Cold snap watch',
  alert_coldsnap_sub: 'Notify me when the low drops below −10°',
  alert_tempdrop_title: 'Temperature drop watch',
  alert_tempdrop_sub: 'Notify me when temperatures fall fast over 6 hours',
  alert_stargazing_title: 'Stargazing watch',
